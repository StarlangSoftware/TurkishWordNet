...
public class WordNet1901Test extends PreviousWordNetTest{
    ...
    public void testSize() {
        assertEquals(41243, previousWordNet.size());
    }
    ...
    public void testSynSetIdCounts() {
        ...
        assertEquals(1293, (int) counts.get("TUR01"));
        assertEquals(271, (int) counts.get("TUR02"));
        assertEquals(93, (int) counts.get("TUR03"));
        assertEquals(37, (int) counts.get("TUR04"));
        assertEquals(128, (int) counts.get("TUR05"));
        assertEquals(134, (int) counts.get("TUR06"));
        assertEquals(225, (int) counts.get("TUR07"));
        assertEquals(86, (int) counts.get("TUR08"));
        assertEquals(118, (int) counts.get("TUR09"));
    ...
    public void testSynSetList() {
        ...
        assertEquals(47776, literalCount);
    }

    @Test
    public void testGetSynSetsWithPartOfSpeech() {
        assertEquals(22968, previousWordNet.getSynSetsWithPartOfSpeech(Pos.NOUN).size());
        assertEquals(6757, previousWordNet.getSynSetsWithPartOfSpeech(Pos.VERB).size());
    ...
    public void testLiteralList() {
        assertEquals(33177, previousWordNet.literalList().size());
    }

    @Test
    public void testLiteralWordCounts() {
        CounterHashMap<Integer> counts = literalWordCounts();
        assertEquals(26335, (int) counts.get(1));
