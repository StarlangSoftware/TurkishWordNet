...
public class WordNet1959Test extends PreviousWordNetTest{
    ...
    public void testSynSetList() {
        ...
        assertEquals(46616, literalCount);
    }
    ...
    public void testGetSynSetsWithPartOfSpeech() {
        ...
        assertEquals(6075, previuosWordNet.getSynSetsWithPartOfSpeech(Pos.ADJECTIVE).size());
    ...
    public void testLiteralList() {
        assertEquals(35629, previuosWordNet.literalList().size());
    }
