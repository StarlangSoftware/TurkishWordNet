...
public class LCHTest {
    ...
    public void testComputeSimilarity() {
        ...
        assertEquals(2.9957, lch.computeSimilarity(turkish.getSynSetWithId("TUR10-0656390"), turkish.getSynSetWithId("TUR10-0600460")), 0.0001);
        ...
        assertEquals(0.6360, lch.computeSimilarity(turkish.getSynSetWithId("TUR10-0195110"), turkish.getSynSetWithId("TUR10-0822980")), 0.0001);
    }
}