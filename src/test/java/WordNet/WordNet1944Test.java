...
public class WordNet1944Test extends PreviousWordNetTest{
    ...
    public void testSize() {
        assertEquals(32581, previousWordNet.size());
    }

    @Test
    public void testSynSetIdCounts() {
        CounterHashMap<String> counts = synSetIdCounts();
        assertEquals(4359, (int) counts.get("TUR01"));
        assertEquals(28217, (int) counts.get("TUR10"));
    }
    ...
    public void testSynSetList() {
        ...
        assertEquals(42710, literalCount);
    }

    @Test
    public void testGetSynSetsWithPartOfSpeech() {
        assertEquals(17862, previousWordNet.getSynSetsWithPartOfSpeech(Pos.NOUN).size());
        assertEquals(7335, previousWordNet.getSynSetsWithPartOfSpeech(Pos.VERB).size());
        ...
        assertEquals(39, previousWordNet.getSynSetsWithPartOfSpeech(Pos.PRONOUN).size());
    }
    ...
    public void testLiteralList() {
        assertEquals(32265, previousWordNet.literalList().size());
    }

    @Test
    public void testLiteralWordCounts() {
        CounterHashMap<Integer> counts = literalWordCounts();
        assertEquals(25281, (int) counts.get(1));
        assertEquals(5851, (int) counts.get(2));
