...
public class WordNet1966Test extends PreviousWordNetTest{
    ...
    public void testSynSetIdCounts() {
        ...
        assertEquals(3301, (int) counts.get("TUR01"));
        assertEquals(1381, (int) counts.get("TUR02"));
    ...
    public void testGetSynSetsWithPartOfSpeech() {
        assertEquals(20116, previousWordNet.getSynSetsWithPartOfSpeech(Pos.NOUN).size());
