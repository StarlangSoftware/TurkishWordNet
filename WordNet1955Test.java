...
public class WordNet1955Test extends PreviousWordNetTest{
    ...
    public void testSynSetIdCounts() {
        ...
        assertEquals(3452, (int) counts.get("TUR01"));
        assertEquals(1481, (int) counts.get("TUR02"));
    ...
    public void testGetSynSetsWithPartOfSpeech() {
        assertEquals(19084, previousWordNet.getSynSetsWithPartOfSpeech(Pos.NOUN).size());
